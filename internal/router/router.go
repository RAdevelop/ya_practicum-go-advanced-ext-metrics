...
func New(h *handler.Handlers, appContext *appcontext.AppContext) http.Handler {

	r := chi.NewRouter()

	r.NotFound(appMiddleware.WithLogging(appContext, http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
